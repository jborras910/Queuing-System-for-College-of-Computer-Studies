...
if(!isset($_GET['queue'])){
    header('location: student_advising.php?IvalidAccess');
}
...
<html lang="en">
    ...
    <body>
        ...
        <?php 
            ...
            $varify_queue_token = $_GET['queue'];
            $_SESSION['student_data']['queue_token'] = $_GET['queue'];
            ...
            <div class="accepted_page">
                <div class="p-2">
                    ...
                    <h6 class="text-capitalize">
                        <?php echo $row['faculty_full_name']?><br><br><span><?php echo $_SESSION['get_faculty_data_row']['faculty_role']?></span>
                    </h6>
        ...
        <div class="main text-center">
            ...
            <div>
                <?php 
                    ...
                    $query = "SELECT * FROM queing_table WHERE isServing='false' AND faculty='$faculty_selected' ORDER BY date asc";
                ...
                <div
                    ...
                    <div style="background: #ffc20f !important; border:4px solid #292929;"
                        class="wait text-center p-5  text-white">

                        <i style="font-size:100px; color: #292929" class="fa-solid fa-lock"></i>
                        <br> <br>
                        <h6 class="text-capitalize" style="color:#292929;">

                            This ticket is lock wait until
            ...
            function loadXMLDoc() {
                ...
                xhttp.open("GET", "queing_reservation_list.php", true);
                xhttp.send();
            }
