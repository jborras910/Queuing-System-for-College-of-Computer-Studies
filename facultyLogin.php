...
<html lang="en">
    ...
    <body>
        ...
        <div class="container">
            ...
            <form class="mt-2" action="function.php" method="POST">
                ...
                <div class="form-group">
                    <input type="password"
                        ...
                        name="password" id="password" class="form-control" placeholder="&#xf023;  Password..." required>
                ...
                <a type="button" href="index.php" class="btn btn-danger text-white">BACK</a>
                <hr>
                <div class="text-center">
                    <label for="">Forget Password? <a href="password_reset.php">Click
                            Here</a></label>
                </div>
            </form>
        </div>
